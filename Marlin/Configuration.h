...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 23.53
  #define DEFAULT_bedKi 0.56
  #define DEFAULT_bedKd 654.18
  #define MAX_CYCLE_TIME_PID_AUTOTUNE 60 // zkrx: prevent PID autotune timeout on my slow bed (default: 20min)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 225, 225, 10, 25 }
